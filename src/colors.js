...
export const colorsBgLight = {
  ...
  successLight: "bg-emerald-300 border-emerald-400 text-white",
...
export const colorsOutline = {
  ...
  successLight: [colorsText.success, "border-emerald-400"],
...
export const getButtonColor = (
  ...
  const colors = {
    ring: {
      ...
      successLight: "ring-emerald-300 dark:ring-emerald-700",
    ...
    active: {
      ...
      successLight:"bg-emerald-600 dark:bg-emerald-500",
    ...
    bg: {
      ...
      successLight: "bg-emerald-500 dark:bg-emerald-400 text-white",
    ...
    bgHover: {
      ...
      successLight:
        "hover:bg-emerald-600 hover:border-emerald-700 hover:dark:bg-emerald-600 hover:dark:border-emerald-600",
      danger:
    ...
    borders: {
      ...
      successLight: "border-emerald-500 dark:border-emerald-500",
